        ...
        {({ open }) => (
          <>
            ...
            <Disclosure.Panel
              ...
              as="p"
            >
              Nuestro exclusivo desarrollo inmobiliario FlamencosCity con 68Ha de superficie privada incluye una gran laguna de 2,5ha de espejo de agua con más de 8.000 m2 de arena de playa. Conformado de casas con terrenos y apartamentos.
              <br></br>
              Usted podra formalizar la escritura en el apartado “Escriturar” de la plataforma, o si lo prefiere comercializar con el en un mercado secundario.
            </Disclosure.Panel>
          </>
        )}
      </Disclosure>
